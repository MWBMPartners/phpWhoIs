...
return [
    ...
    // ═════════════════════════════════════════════════════════════
    //  Standard — unfiltered public DNS
    // ═════════════════════════════════════════════════════════════

    // ── Global / Anycast ──
    ['id' => 1,  'enabled' => true,  'name' => 'Google',          'ip' => '8.8.8.8',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 2,  'enabled' => true,  'name' => 'Google',          'ip' => '8.8.4.4',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 3,  'enabled' => true,  'name' => 'Cloudflare',      'ip' => '1.1.1.1',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 4,  'enabled' => true,  'name' => 'Cloudflare',      'ip' => '1.0.0.1',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 5,  'enabled' => true,  'name' => 'Quad9',           'ip' => '9.9.9.9',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 6,  'enabled' => true,  'name' => 'Quad9',           'ip' => '149.112.112.112',  'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 7,  'enabled' => true,  'name' => 'OpenDNS',         'ip' => '208.67.222.222',   'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 8,  'enabled' => true,  'name' => 'OpenDNS',         'ip' => '208.67.220.220',   'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 9,  'enabled' => true,  'name' => 'DNS.SB',          'ip' => '185.222.222.222',  'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],
    ['id' => 10, 'enabled' => true,  'name' => 'DNS.SB',          'ip' => '45.11.45.11',      'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'standard'],

    // ── North America ──
    ['id' => 11, 'enabled' => true,  'name' => 'Comodo Secure',   'ip' => '8.26.56.26',       'country_code' => 'US',     'location' => 'US',           'type' => 'standard'],
    ['id' => 12, 'enabled' => true,  'name' => 'Comodo Secure',   'ip' => '8.20.247.20',      'country_code' => 'US',     'location' => 'US',           'type' => 'standard'],
    ...
    ['id' => 35, 'enabled' => true,  'name' => 'G-Core',          'ip' => '95.85.95.85',      'country_code' => 'LU',     'location' => 'Luxembourg',   'type' => 'standard'],
    ['id' => 36, 'enabled' => true,  'name' => 'G-Core',          'ip' => '2.56.220.2',       'country_code' => 'LU',     'location' => 'Luxembourg',   'type' => 'standard'],
    ...
    ['id' => 43, 'enabled' => true,  'name' => 'Yandex',          'ip' => '77.88.8.8',        'country_code' => 'RU',     'location' => 'Russia',       'type' => 'standard'],
    ['id' => 44, 'enabled' => true,  'name' => 'Yandex',          'ip' => '77.88.8.1',        'country_code' => 'RU',     'location' => 'Russia',       'type' => 'standard'],
    ...
    ['id' => 55, 'enabled' => false, 'name' => 'Cloudflare',      'ip' => '1.1.1.2',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ['id' => 56, 'enabled' => false, 'name' => 'Cloudflare',      'ip' => '1.0.0.2',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ...
    ['id' => 59, 'enabled' => false, 'name' => 'CleanBrowsing',   'ip' => '185.228.168.9',    'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ['id' => 60, 'enabled' => false, 'name' => 'CleanBrowsing',   'ip' => '185.228.169.9',    'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ...
    ['id' => 63, 'enabled' => false, 'name' => 'Quad9',           'ip' => '9.9.9.11',         'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ['id' => 64, 'enabled' => false, 'name' => 'Quad9',           'ip' => '149.112.112.11',   'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'security'],
    ['id' => 65, 'enabled' => false, 'name' => 'Yandex',          'ip' => '77.88.8.88',       'country_code' => 'RU',     'location' => 'Russia',       'type' => 'security'],
    ['id' => 66, 'enabled' => false, 'name' => 'Yandex',          'ip' => '77.88.8.2',        'country_code' => 'RU',     'location' => 'Russia',       'type' => 'security'],

    // ═════════════════════════════════════════════════════════════
    //  Family — parental control / adult content (disabled by default)
    // ═════════════════════════════════════════════════════════════

    ['id' => 67, 'enabled' => false, 'name' => 'Cloudflare',      'ip' => '1.1.1.3',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ['id' => 68, 'enabled' => false, 'name' => 'Cloudflare',      'ip' => '1.0.0.3',          'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ['id' => 69, 'enabled' => false, 'name' => 'OpenDNS',         'ip' => '208.67.222.123',   'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ['id' => 70, 'enabled' => false, 'name' => 'OpenDNS',         'ip' => '208.67.220.123',   'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ...
    ['id' => 73, 'enabled' => false, 'name' => 'CleanBrowsing',   'ip' => '185.228.168.168',  'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ['id' => 74, 'enabled' => false, 'name' => 'CleanBrowsing',   'ip' => '185.228.169.168',  'country_code' => 'GLOBAL', 'location' => 'Anycast',      'type' => 'family'],
    ...
    ['id' => 77, 'enabled' => false, 'name' => 'Yandex',          'ip' => '77.88.8.7',        'country_code' => 'RU',     'location' => 'Russia',       'type' => 'family'],
    ['id' => 78, 'enabled' => false, 'name' => 'Yandex',          'ip' => '77.88.8.3',        'country_code' => 'RU',     'location' => 'Russia',       'type' => 'family'],
];
